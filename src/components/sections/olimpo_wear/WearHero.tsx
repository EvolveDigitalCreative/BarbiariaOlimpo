    ...
    return (
        <section className="wear-hero-section">
            <div className="wear-hero-split">
                {/* Imagem da esquerda */}
                <img src="/wear/images/hero-left.jpg" alt="Coleção Wear Esquerda" style={{ filter: 'brightness(0.8)' }}/>
                
                {/* Imagem da direita */}
                <img src="/wear/images/hero-right.jpg" alt="Coleção Wear Direita" style={{ filter: 'brightness(0.7)' }}/>
            </div>
